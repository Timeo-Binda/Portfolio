...
useHead({
  title: `${projets_designInfo.titre}`
});
</script>
...
<template>
  <div class="relative group overflow-hidden pointer-events-auto">
     ...
     <p class="text-2xl font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity">{{ projets_designInfo.titre }}</p>
  </div>
</template>
